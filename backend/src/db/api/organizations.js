...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.budgets_organization = await organizations.getBudgets_organization({
      transaction,
    });
    ...
    output.guests_organization = await organizations.getGuests_organization({
      transaction,
    });

    output.vendors_organization = await organizations.getVendors_organization({
      transaction,
    });

    output.venues_organization = await organizations.getVenues_organization({
      transaction,
    });
