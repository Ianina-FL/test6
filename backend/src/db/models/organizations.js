...
module.exports = function (sequelize, DataTypes) {
  ...
  organizations.associate = (db) => {
    ...
    db.organizations.hasMany(db.budgets, {
      as: 'budgets_organization',
      foreignKey: {
        name: 'organizationId',
      },
      constraints: false,
    ...
    db.organizations.hasMany(db.vendors, {
      as: 'vendors_organization',
      foreignKey: {
        name: 'organizationId',
      },
      constraints: false,
    ...
    db.organizations.hasMany(db.venues, {
      as: 'venues_organization',
      foreignKey: {
        name: 'organizationId',
      },
      constraints: false,
