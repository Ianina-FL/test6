...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/budgets/budgetsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureBudgetsCols';
...
const TableSampleBudgets = ({
  ...
  useEffect(() => {
    if (budgetsNotify.showNotification) {
      notify(budgetsNotify.typeNotification, budgetsNotify.textNotification);
    }
  }, [budgetsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/budgets/budgets-view/?id=${id}`);
  };
...
export default TableSampleBudgets;
