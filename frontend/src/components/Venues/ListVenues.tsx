...
const ListVenues = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_VENUES');
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>IsBooked</p>
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/venues/venues-edit/?id=${item.id}`}
                  pathView={`/venues/venues-view/?id=${item.id}`}
