      ...
      <div
        className={`${corners !== 'rounded-full' ? corners : 'rounded-3xl'} ${
          design === ContactFormDesigns.SIMPLE_CLEAN_DIVERSITY
            ? 'bg-pastelEmeraldTheme-diversityContact '
            : 'bg-pastelEmeraldTheme-buttonColor'
        } p-12  mb-16`}
      >
          ...
          >
            ...
            <div className='space-y-2'>
              ...
              >
                ...
                />
                <a href='ianina.podosenova@flatlogic.com'>
                  ianina.podosenova@flatlogic.com
                </a>
              </p>
            </div>
          </div>
              ...
              {({ isSubmitting }) => (
                ...
                >
                  ...
                  <BaseButton
                    ...
                    className={`w-1/2 md:w-1/4 text-sm mt-4 text-pastelEmeraldTheme-buttonColor   ${corners}`}
