...
const Dashboard = () => {
  ...
  const [budgets, setBudgets] = React.useState('Loading...');
  const [events, setEvents] = React.useState('Loading...');
  const [guests, setGuests] = React.useState('Loading...');
  const [vendors, setVendors] = React.useState('Loading...');
  const [venues, setVenues] = React.useState('Loading...');
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiHomeCity || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
